...
préparation d’un runner hébergé ou avant la fin des trois contrôles confirmant
une panne. Cette marge ne masque pas une erreur applicative : les commandes et
leurs délais réseau restent bornés, et le job final échoue toujours après trois
contrôles négatifs.
