...
(function () {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .family-verdict[data-state="GO_SOON"] .verdict-badge,.family-verdict[data-state="NO_GO"] .verdict-badge{background:var(--warn);color:#1a1002}.family-verdict[data-state="STALE"] .verdict-badge,.family-verdict[data-state="NO_DATA"] .verdict-badge{background:color-mix(in srgb,var(--bad) 72%,#000);color:#fff}
