...
def test_family_view_keeps_its_summary_host():
    script = (ROOT / "public" / "family-view.js").read_text(encoding="utf-8")

    assert "summary.id = 'family-summary'" in script
    assert "dashboard.insertAdjacentElement('beforebegin', summary)" in script
